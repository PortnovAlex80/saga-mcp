...
CREATE INDEX IF NOT EXISTS idx_factory_work_intents_epic
  ON factory_work_intents(epic_id);
CREATE INDEX IF NOT EXISTS idx_factory_work_intents_kind_status
  ON factory_work_intents(kind, status);
