 ...
 *
 * The concrete SQLite adapter (`SqliteDeliveryOutputRepository`,
 * `ensureDeliveryPersistenceSchema`) physically lives in
 * `src/infrastructure/process-modules/delivery/delivery-persistence.ts`
 ...
 */
export {
  SqliteDeliveryOutputRepository,
  ensureDeliveryPersistenceSchema,
} from '../../../infrastructure/process-modules/delivery/delivery-persistence.js';
