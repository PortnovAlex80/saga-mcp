 ...
 *
 * The concrete SQLite runtime (`SqliteDeliveryRuntime`,
 * `SqliteDeliveryRuntimeOptions`) physically lives in
 * `src/infrastructure/process-modules/delivery/sqlite-delivery-runtime.ts`
 ...
 */
export {
  SqliteDeliveryRuntime,
  type SqliteDeliveryRuntimeOptions,
} from '../../../infrastructure/process-modules/delivery/sqlite-delivery-runtime.js';
