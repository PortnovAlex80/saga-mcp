...
export const DISCOVERY_PROPOSAL_SUBMIT_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-proposal.v1', '1.0.0'),
  outputContractRef: contractRef('saga3.discovery-proposal.v1', '1.0.0'),
...
export const DISCOVERY_NORMALIZATION_GET_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-normalization-control.v1', '1.0.0'),
  outputContractRef: contractRef('saga3.discovery-normalization-proposal.v1', '1.0.0'),
...
export const DISCOVERY_NORMALIZATION_SUBMIT_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-normalization-proposal.v1', '1.0.0'),
  outputContractRef: contractRef('saga3.discovery-normalization-proposal.v1', '1.0.0'),
...
export const DISCOVERY_READINESS_GET_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-readiness-control.v1', '1.0.0'),
  outputContractRef: contractRef('saga3.discovery-readiness-assessment.v1', '1.0.0'),
...
export const DISCOVERY_READINESS_SUBMIT_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-readiness-assessment.v1', '1.0.0'),
  outputContractRef: contractRef('saga3.discovery-readiness-assessment.v1', '1.0.0'),
...
export const DISCOVERY_DIAGNOSIS_GET_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-diagnosis-control.v1', '1.0.0'),
  outputContractRef: contractRef('saga3.discovery-diagnosis.v1', '1.0.0'),
...
export const DISCOVERY_DIAGNOSIS_SUBMIT_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-diagnosis.v1', '1.0.0'),
  outputContractRef: contractRef('saga3.discovery-diagnosis.v1', '1.0.0'),
...
export const DISCOVERY_BRIEF_ARTIFACT_CREATE_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('saga3.discovery-brief.v1', '1.0.0'),
