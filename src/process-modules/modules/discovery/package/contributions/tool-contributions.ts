...
export const DISCOVERY_READINESS_GET_CONTRIBUTION: ModuleToolContribution = {
  ...
  outputContractRef: contractRef('factory.discovery-readiness-assessment.v2', '2.0.0'),
...
export const DISCOVERY_READINESS_SUBMIT_CONTRIBUTION: ModuleToolContribution = {
  ...
  version: '1.0.0',
  inputContractRef: contractRef('factory.discovery-readiness-assessment.v2', '2.0.0'),
  outputContractRef: contractRef('factory.discovery-readiness-assessment.v2', '2.0.0'),
