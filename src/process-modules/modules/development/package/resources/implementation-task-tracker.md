...
- process_module_ref: `solution-development@1.4.0`
...
- [ ] 8. Acquire the merge lock with `worker_merge_acquire`, merge into the integration branch, then call `worker_merge_release(result="merged", commit_sha=...)`.
