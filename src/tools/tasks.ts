...
export const definitions: Tool[] = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        status: {
          type: 'string',
          enum: ['todo', 'in_progress', 'review', 'review_in_progress', 'done', 'blocked', 'failed', 'cancelled'],
          default: 'todo',
        },
        priority: {
          type: 'string',
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        status: { type: 'string', enum: ['todo', 'in_progress', 'review', 'review_in_progress', 'done', 'blocked', 'failed', 'cancelled'] },
