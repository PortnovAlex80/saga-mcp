/**
 * metrics-dashboard/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ["src/server.mjs","public/index.html","public/app.js","public/style.css"];
...
const input = { kind: 'metrics-dashboard.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('metrics-dashboard package: ' + bundleDigest + '\n');
