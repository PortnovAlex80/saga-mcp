/**
 * cli-stats/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const input = { kind: 'cli-stats.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('cli-stats package: ' + bundleDigest + '\n');
