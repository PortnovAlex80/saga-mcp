/**
 * served-crud/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ["src/server.mjs","src/store.mjs","public/index.html","public/app.js","public/style.css"];
...
const input = { kind: 'served-crud.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('served-crud package: ' + bundleDigest + '\n');
