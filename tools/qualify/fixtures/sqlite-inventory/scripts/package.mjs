/**
 * sqlite-inventory/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ["src/server.mjs","src/inventory.mjs"];
...
const input = { kind: 'sqlite-inventory.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('sqlite-inventory package: ' + bundleDigest + '\n');
