/**
 * cli-packager/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const input = { kind: 'cli-packager.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('cli-packager package: ' + bundleDigest + '\n');
