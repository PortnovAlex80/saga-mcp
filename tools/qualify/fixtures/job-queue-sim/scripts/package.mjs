/**
 * job-queue-sim/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const input = { kind: 'job-queue-sim.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('job-queue-sim package: ' + bundleDigest + '\n');
