/**
 * webhook-receiver/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const input = { kind: 'webhook-receiver.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('webhook-receiver package: ' + bundleDigest + '\n');
