/**
 * md-site/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ["src/render.mjs","content.md"];
...
const input = { kind: 'md-site.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('md-site package: ' + bundleDigest + '\n');
