/**
 * canvas-game/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ["src/game.mjs","public/index.html","public/game.js"];
...
const input = { kind: 'canvas-game.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('canvas-game package: ' + bundleDigest + '\n');
