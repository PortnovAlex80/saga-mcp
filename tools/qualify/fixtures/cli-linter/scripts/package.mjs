/**
 * cli-linter/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const input = { kind: 'cli-linter.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('cli-linter package: ' + bundleDigest + '\n');
