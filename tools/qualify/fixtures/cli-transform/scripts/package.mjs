/**
 * cli-transform/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ["src/transform.mjs"];
...
const input = { kind: 'cli-transform.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('cli-transform package: ' + bundleDigest + '\n');
