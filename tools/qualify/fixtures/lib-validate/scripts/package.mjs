/**
 * lib-validate/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const input = { kind: 'lib-validate.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('lib-validate package: ' + bundleDigest + '\n');
