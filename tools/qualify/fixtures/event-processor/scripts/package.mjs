/**
 * event-processor/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ["src/pipeline.mjs","events.log"];
...
const input = { kind: 'event-processor.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write('event-processor package: ' + bundleDigest + '\n');
