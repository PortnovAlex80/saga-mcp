...
const QUARANTINE = [
  ...
  { glob: 'tests/architecture/worker-done-completion-authority.test.mjs',
    kind: 'PRE-EXISTING-RED',
    reason: 'imports deleted module dist/process-modules/application/node-executors/receipt-aware-lm-persistence.js (removed in refactor 5530965).' },
