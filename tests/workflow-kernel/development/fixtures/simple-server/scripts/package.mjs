/**
 * simple-server/scripts/package.mjs - the LOCAL packaging/delivery input:
...
const INPUTS = ['src/server.js', 'public/index.html', 'public/app.js', 'package.json', 'acceptance-contract.json'];
...
const input = { kind: 'simple-server.delivery-input.v1', entries, bundleDigest, externalDeployment: false };
...
process.stdout.write(`simple-server package: ${bundleDigest}\n`);
