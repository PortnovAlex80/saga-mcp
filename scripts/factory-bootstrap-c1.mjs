...
db.prepare(`INSERT INTO lifecycle_execution_controls (epic_id,concurrency,model_provider,model_name,model_effort,model_concurrency_limit) VALUES (1,1,'zai',?, 'medium',5)`).run(modelName);
...
db.prepare(`INSERT INTO factory_launch_requests (launch_ref,order_ref,mode,project_id,epic_id,lifecycle_input_json,lifecycle_input_schema,initiated_by,idempotency_key,concurrency,state) VALUES (?,?,'new',1,1,?,?,?, ?,1,'requested')`).run(
  launchRef, orderRef,
