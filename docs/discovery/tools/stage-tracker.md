...
- [ ] 3. Copy discovery-doc-template.md → docs/discovery/projects/{EPIC_ID}/discovery-{EPIC_ID}.md, fill it in
- [ ] 4a. Copy proposal-call-template.json → docs/discovery/projects/{EPIC_ID}/proposal-call-{EPIC_ID}.json, fill it in
- [ ] 4b. Read proposal-call-{EPIC_ID}.json back, verify ALL fields (see proposal-checklist.md)
...
- [ ] 7a. Copy readiness-call-template.json → docs/discovery/projects/{EPIC_ID}/readiness-call-{EPIC_ID}.json, fill it in using ONLY proposal_id / proposal_content_hash from readiness_get, and source_refs from allowed_source_refs
- [ ] 7b. Read readiness-call-{EPIC_ID}.json back, verify ALL fields (see readiness-checklist.md)
...
- [ ] 10a. Copy diagnosis-call-template.json → docs/discovery/projects/{EPIC_ID}/diagnosis-call-{EPIC_ID}.json, fill it in using certificate id/hash/settlement_input_hash/decision VERBATIM from diagnosis_case.certificate; cite ONLY policy_trace conditions with contributed_to_decision === true
- [ ] 10b. Read diagnosis-call-{EPIC_ID}.json back, verify ALL fields (see diagnosis-checklist.md), including the decision-specific rules and the forbidden-fields check
