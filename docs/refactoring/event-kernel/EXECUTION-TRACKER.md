| WP-13B | Actors, fault scheduler, production-size fixtures | WP-07, WP-18 | subagent | **RUNNING** (2026-08-26 wave) | — | — | actor/fault test paths | — || WP-13A | Scenario contract/model comparison/minimizer | WP-05 | subagent | **DONE** | `98af7971` (merge) | 47/47 test-engine core | scenario contract + comparison + minimizer | — || WP-09 | Planning, dependency, aggregate settlement | WP-07 | subagent | **RUNNING** (2026-08-26 wave) | — | — | WorkItem/aggregate composition | — || WP-08 | Development/material vertical + capsule ingress | WP-07, WP-17, WP-18 | subagent | **RUNNING** (2026-08-26 wave) | — | — | Development adapter + simple-server corpus | — || WP-18 | Context envelope + receipt protocol | WP-07, WP-17 | subagent | **DONE** | `7d0c2dd0` (merge) | 55/55 context-envelope; CAS race fixed | admitProviderRequest + pre-send boundary + D12 wait | EK-8 must pin RUNNING_COUNTER_IDENTITY || WP-17 | CanonicalRoleContract compiler + consumer port | WP-05 | subagent | **DONE** | `322d6dc2` (merge) | 37/37, one path, zero fallback | role compiler/resolver + fixtures | — || WP-07 | Obligation consumer, waits, fault points | WP-06 | subagent | **DONE** | `e4d661e0` (merge) | 32/32 application suites, crash matrix 16x identical worlds | obligation-consumer.ts per frozen dimension | pre-existing arch red verified at clean base 5b6f5dbd || WP-06 | Greenfield schema + repositories | WP-05 | subagent | **DONE** | `5b6f5dbd` (merge) | 36/36 persistence | src/workflow-kernel/persistence/** | loadContextCounters added by WP-07 (cross-boundary, owner-noted) || WP-05 | Pure kernel reducers + model explorer | EK-1, WP-16 | subagent | **DONE** | `7394cf92` (merge) | test:workflow-model 69/69, 12 mutations killed | src/workflow-kernel/domain/** | — |# Event-Kernel Refactoring — Execution Tracker
