...
| WP-16 | Freeze + validate the three admission specs | WP-01..04 | 3 spec agents | **16c DONE** (1258cec7: schema+classification+semantics, 21/21 det., 3 RED); 16a/16b RUNNING | pending | validate:ek-admission-specs + EK-ADMISSION-RECEIPT.json | package.json wiring = coordinator EK-1 exit |
