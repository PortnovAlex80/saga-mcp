| WP-13A | Scenario contract/model comparison/minimizer | WP-05 | subagent | **DONE** | merge 98af7971 | 47/47 engine core | engine/** | — || WP-18 | Context envelope + receipt protocol | WP-07, WP-17 | subagent | **DONE** | merge 7d0c2dd0 | 55/55; pre-send admission; D12 transport | context-envelope/** | counter identity pinned EK-8 || WP-17 | CanonicalRoleContract compiler + consumer port | WP-05 | subagent | **DONE** | merge 322d6dc2 | 37/37, one path, zero fallback | roles/** | — || WP-07 | Obligation consumer, waits, fault points | WP-06 | subagent | **DONE** | merge e4d661e0 | 32/32; crash matrix 16x identical | application/** | — || WP-06 | Greenfield schema + repositories | WP-05 | subagent | **DONE** | merge 5b6f5dbd | 36/36; sole-writer ratchets | persistence/** | loadContextCounters (owner-noted) || WP-05 | Pure kernel reducers + model explorer | EK-1, WP-16 | subagent | **DONE** | merge 7394cf92 | model 69/69 (71/71 with rung pins), 12 mutations killed | domain/** | — || Package | Bounded assignment | Depends on | Owner | Status | Commit | Verifier | Evidence | Residual |
|---|---|---|---|---|---|---|---|---|
...
| WP-05 | Pure kernel reducers + model explorer | EK-1, WP-16 | subagent | **DONE** | merge 7394cf92 | model 69/69 (71/71 with rung pins), 12 mutations killed | domain/** | — |
| WP-06 | Greenfield schema + repositories | WP-05 | subagent | **DONE** | merge 5b6f5dbd | 36/36; sole-writer ratchets | persistence/** | loadContextCounters (owner-noted) |
| WP-07 | Obligation consumer, waits, fault points | WP-06 | subagent | **DONE** | merge e4d661e0 | 32/32; crash matrix 16x identical | application/** | — |
| WP-17 | CanonicalRoleContract compiler + consumer port | WP-05 | subagent | **DONE** | merge 322d6dc2 | 37/37, one path, zero fallback | roles/** | — |
| WP-18 | Context envelope + receipt protocol | WP-07, WP-17 | subagent | **DONE** | merge 7d0c2dd0 | 55/55; pre-send admission; D12 transport | context-envelope/** | counter identity pinned EK-8 |
...
| WP-11V | Development semantic package finalization | WP-08, WP-09, WP-17 | subagent | **DONE** | merge after 0e8ddbbe | development 38/38 + synthetic 20/20; generalization proof (no new kernel kind) | workshops/development + synthetic/** | already-applied-only world cannot reach run-success (EK-8 reconciliation) 
| WP-11L | Delivery semantic package conversion | WP-09, WP-17 | subagent | **DONE** | merge after 87d304a1 | delivery 55/55 | workshops/delivery/** | recordHumanDecision edge resolved (D12 node rung) || WP-11F | Formalization semantic package conversion | WP-09, WP-17 | subagent | **DONE** | merge after 06cab6f1 | formalization 68/68 | workshops/formalization/** | open frontier rows (reference posture) || WP-11D | Discovery semantic package conversion | WP-09, WP-17 | subagent | **DONE** | merge after fbc54b86 | discovery 74/74 | workshops/discovery/** | — || WP-10 | Kanban projection + command-only UI adapters | WP-08, WP-09, WP-17 | subagent | **DONE** | merge after 80c7a39e | projection 30/30; 3 mandatory mutations | projection/** | — || WP-09 | Planning, dependency, aggregate settlement | WP-07 | subagent | **DONE** | merge after afa59c17 | planning 42/42; 7 RED kills; topology bindings | planning/** | upstream-repair lane refinement (post-EK-11 backlog) || WP-08 | Development/material vertical + capsule ingress | WP-07, WP-17, WP-18 | subagent | **DONE** | merge after 047cb2f3 | development 55/55; capsule 9-digest ingress; 6 typed refusals | development/** + simple-server corpus | refused-receipt durability (EK-8 pinned); frontier shadowing (WP-09 resolved) || WP-15 | Immutable scripted + real qualification | EK-10, WP-16..18 | subagent + coordinator | **DRIVERS DONE; EK-11 re-run PENDING final kit; EK-12 IN FLIGHT** | merge after cd6ca460 | kit/fences/drivers; scripted series green on kit 2f428238 (superseded by later HEAD); real-series prewire 7/7 | tools/qualify/** | NODE_UNDECLARED work-item:1 regression (real R2 bring-up) || WP-14 | Canonical docs rewrite + deletion patch | EK-1 | subagent | **DONE** | merge cd909744 | 8 docs + linter spec | documentation paths | post-cutover doc pass rides EK-13 || WP-13D | 20-project corpus + qualification drivers | WP-08, WP-13A | subagent | **DONE** | merge after f82cb167 | corpus 33/33; --full 20/20; kit replay 2/2 | tests/project-corpus + tools/project-corpus | findings 1+2 fixed; 3 deferred (ledger) || WP-13C | CI hosting, removal guards, mutation coverage | WP-13A/B | subagent | **DONE** | merge after 830082e9 (cfa273d1) | removal 9/9, mutation-cov 2/2, evidence-kit 3/3; 6/6 mutations killed | matrix/ci + ek-* tools | RG3c pinned partial-survival findings || WP-13B | Actors, fault scheduler, production-size fixtures | WP-07, WP-18 | subagent | **DONE** | merge after 4fc531ae | 64/64; 16-point crash matrix; Elite-3 436,283B fixture | actors/faults/fixtures/** | — || WP-13A | Scenario contract/model comparison/minimizer | WP-05 | subagent | **DONE** | merge 98af7971 | 47/47 engine core | engine/** | — || WP-11V | Development semantic package finalization | WP-08, WP-09, WP-17 | subagent | **DONE** | merge after 0e8ddbbe | development 38/38 + synthetic 20/20 | workshops/development + synthetic/** | already-applied-only world run-success edge (EK-8 reconciled) || WP-18 | Context envelope + receipt protocol | WP-07, WP-17 | subagent | **DONE** | merge 7d0c2dd0 | 55/55; pre-send admission; D12 transport | context-envelope/** | RUNNING_COUNTER_IDENTITY pinned at EK-8 || WP-17 | CanonicalRoleContract compiler + consumer port | WP-05 | subagent | **DONE** | merge 322d6dc2 | 37/37, one path, zero fallback | roles/** | — || WP-07 | Obligation consumer, waits, fault points | WP-06 | subagent | **DONE** | merge e4d661e0 | 32/32; crash matrix 16x identical worlds | application/** | — || WP-06 | Greenfield schema + repositories | WP-05 | subagent | **DONE** | merge 5b6f5dbd | 36/36 persistence; sole-writer ratchets | persistence/** | loadContextCounters cross-boundary (owner-noted) || WP-05 | Pure kernel reducers + model explorer | EK-1, WP-16 | subagent | **DONE** | merge 7394cf92 | model 69/69 (now 71/71 with rung pins), 12 mutations killed | domain/** | — || WP-13D | 20-project corpus + qualification drivers | WP-08, WP-13A | subagent | **DONE** | merge after f82cb167 | corpus 33/33; --full 20/20 green; kit replay 2/2 (elite-8 truthful-failure, elite-fresh blocked-honest) | tests/project-corpus + tools/project-corpus | 3 kernel findings (dupe-effect scope, human-decision node edge, drain oracle) 
...
| WP-15 | Immutable scripted + real qualification | EK-10, WP-16..18 | subagent + coordinator | **DRIVERS DONE; EK-11 re-run PENDING final kit; EK-12 IN FLIGHT** | merge after cd6ca460 | kit/fences/drivers; scripted series green on kit 2f428238 (superseded by later HEAD — full re-run required per audit); prewire 7/7 | tools/qualify/** | NODE_UNDECLARED work-item:1 regression (real R2 bring-up) |
