...
The freeze-what-baseline desk establishes WorkplaceProductionRevision as the sole material authority for baseline artifacts. This immutable revision captures the exact state of all desk material at baseline freeze time and serves as the authoritative source for all downstream operations.
...
**Resolution of UNK-1:**
The baseline freeze scope includes all direct desk artifacts (claims, constraints, unknowns, terminal claims) and their immediate dependencies. The WorkplaceProductionRevision captures this minimal complete set needed for baseline authority.
...
1. ✅ All baseline artifacts are content-addressed
...
- Resolves UNK-1: baseline scope = direct artifacts + immediate dependencies
- Consistent with ADR-053 architecture
- Follows CONVEYOR-MENTAL-MODEL.md principles

## Status

Accepted as terminal claim establishing baseline material authority architecture.