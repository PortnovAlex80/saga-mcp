# Terminal Claim 2: Content Address Baseline Transport
...
The freeze-what-baseline desk implements content address transport for all baseline material movement. Baseline artifacts travel through the system by their SHA256 content digests, ensuring immutability, authority preservation, and cross-process consistency.
...
interface ContentAddressTransport {
  baselineArtifactRefs: ContentAddressedReference[];
...
1. ✅ All baseline artifacts identified by SHA256 digest
...
Accepted as terminal claim establishing content address transport for baseline material.