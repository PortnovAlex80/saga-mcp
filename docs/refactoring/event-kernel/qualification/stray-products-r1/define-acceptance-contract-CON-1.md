...
All material transport between define-acceptance-contract desk components must use content address referencing. Material identity is determined solely by cryptographic content digest, never by mutable identifiers, execution IDs, or path references.
...
Accepted as binding constraint for define-acceptance-contract desk implementation.