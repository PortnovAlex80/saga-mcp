# Unknown 1: Acceptance Contract Scope
...
What is the precise scope of material that should be frozen in the define-acceptance-contract desk? Should the acceptance contract include only direct desk artifacts, or should it also include transitive dependencies and referenced external material?

## Context

The define-acceptance-contract desk operates with 0 accepted upstream revisions traveling by content address. This suggests a clean slate, but the scope of what constitutes "acceptance contract material" needs clarification:
...
**Option C - Comprehensive Scope**: Freeze all material that could influence acceptance contract interpretation, including external documents. Pros: Maximum completeness. Cons: Very large, potential over-inclusion.
