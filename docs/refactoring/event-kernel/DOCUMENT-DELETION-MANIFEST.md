...
| Idea notes | `ideas/**` (3 md) | DELETE | old testbed inputs |
...
| Test-fixture documents (other) | `tests/characterization/fixtures/2026-08-28-failures/**` (8), `tests/factory-contract/design/**` (11), `tests/fixtures/synthetic-{modules,scenarios}/**` (5), `tests/installation/fixtures/**` (2), `tests/matrix/` (1) | DELETE at EK-9 | fixtures/design notes of deleted old-format suites (legacy manifest §E split rule) |
