...
| CC-GAP-7 (deliverable-aware oracle) | OPEN — no warrant-execution landing. Chosen direction only (2026-08-23): A-prime — package-owned warrant catalogs with kernel-owned minimum floors; ADR-093 is upcoming and NOT yet present in the repository; no implementation is claimed |
