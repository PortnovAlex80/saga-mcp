...
| B5 | §8 | missing reason coverage (clarify/reject) | a certificate reason_code not covered by any cause ⇒ rejected | `d5-diagnosis-validator.test.mjs` | `D5 validator: missing reason coverage rejected` | pure |
